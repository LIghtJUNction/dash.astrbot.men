 ...
 */
export const listChatProjectWorkspaceFiles = <ThrowOnError extends boolean = false>(options: OpenApiClientOptions<ListChatProjectWorkspaceFilesData, ThrowOnError>) => {
 ...
 */
export const getChatProjectWorkspaceFile = <ThrowOnError extends boolean = false>(options: OpenApiClientOptions<GetChatProjectWorkspaceFileData, ThrowOnError>) => {
 ...
 */
export const downloadChatProjectWorkspaceFile = <ThrowOnError extends boolean = false>(options: OpenApiClientOptions<DownloadChatProjectWorkspaceFileData, ThrowOnError>) => {
 ...
 */
export const updatePluginLogLevel = <ThrowOnError extends boolean = false>(options: OpenApiClientOptions<UpdatePluginLogLevelData, ThrowOnError>) => {
 ...
 */
export const installPluginFromGit = <ThrowOnError extends boolean = false>(options: OpenApiClientOptions<InstallPluginFromGitData, ThrowOnError>) => {
